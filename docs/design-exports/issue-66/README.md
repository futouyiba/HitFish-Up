...
- Canvas read time and route：**9 帧**＝定位盘存读取 `2026-09-22T11:46:50Z`（inventory locator，不是像素校验窗口）；**7 帧（重导）**＝doc 读取 `2026-09-23T05:12:55Z`／帧核 `2026-09-23T05:13:10Z`（服务端导出，1×）。
...
- Image/live consistency：**9 帧 `unverified`：只有定位盘存、没有可追溯的像素校验窗口**；**7 帧 `consistent` @ `2402269427359123151`，读取窗口 `2026-09-23T05:12:55Z–05:13:10Z`**。★ **时点性读数**：每组只绑定自己的画布版本与读取窗口，不宣称永久。
- Export time：**按组两区间** —— **9 帧**：`未落/待核；定位盘存区间 [2026-09-22T11:46:50Z, 2026-09-23T02:59:04Z]`（**下界＝#92 README inventory read time；上界＝#92 首笔 `d235a31c` committedDate**；无像素校验窗口，故 9 帧不标 `consistent`）；**7 帧（重导）**：`2026-09-23T05:12:55Z–05:13:10Z`（逐帧服务端导出/核验时点；本地无更精确日志，不猜测）。
- Proof boundary：the PNG proves only static pixels at export time; it does not prove runtime behavior or persistence.
...
| A②-卡8 Template Library List | `proj_tl_2` | 待核 | 单帧 | 890×150 | `9b7b6c9fa7d4ad9d92f50539773f307661daed762d491ade6005058c0830a5e5` | 未落/待核 | `unverified` | 无标记 |
| A②-卡8 Template Library List | `proj_tl_3` | 待核 | 单帧 | 890×150 | `8c46918bf0445955076d787680c92ccd6cc76560e9d5ba22bb8bd5dd678df931` | 未落/待核 | `unverified` | 无标记 |
| A②-卡8 Template Library List | `proj_tl_4` | 待核 | 单帧 | 890×188 | `9de07b4f93a20b4666efbf596657782475795eadf15326a207e11e76af6b11e8` | 未落/待核 | `unverified` | 无标记 |
...
| A②-卡12 Reference List | `proj_rl_2` | 待核 | 单帧 | 890×150 | `a39f42060cee7a4c427c4f8a99774408804363e48f2c0e5aed21a5d0c366e478` | 未落/待核 | `unverified` | 无标记 |
| A②-卡12 Reference List | `proj_rl_3` | 待核 | 单帧 | 890×150 | `560c3706ca0b999f47e28c344684717fd201cebd1220adf8b5b95ce5de7bfb92` | 未落/待核 | `unverified` | 无标记 |
| A①-RoleControl 两入口／记录态／行级操作 | `proj_role_1` | 待核 | 单帧 | 890×176 | `dc04725b027a1e37eab48635c2cfd2ba8fa5aadb53f681a1ec522df32853f9c3` | 未落/待核 | `unverified` | `⚑UNIMPL` |
| A①-RoleControl 两入口／记录态／行级操作 | `proj_role_2` | 待核 | 单帧 | 890×176 | `1edc439857fe6284b562cf9a77bb1c5e0dcdb56d7c9ba8f5a3a017dbde8c54c9` | 未落/待核 | `unverified` | `⚑UNIMPL` |
| A①-RoleControl 两入口／记录态／行级操作 | `proj_role_3` | 待核 | 单帧 | 890×176 | `d9e015de87e568ae67a573ca85838398c73518d6fb0cb708cc14909f7c36e587` | 未落/待核 | `unverified` | `⚑UNIMPL` |
| A①-RoleControl 两入口／记录态／行级操作 | `proj_role_4` | 待核 | 单帧 | 890×176 | `053917b5097d1cdaebc085dfdd3dbd0603adc7a2e343128ad85f4ae70d344612` | 未落/待核 | `unverified` | `⚑UNIMPL` |
