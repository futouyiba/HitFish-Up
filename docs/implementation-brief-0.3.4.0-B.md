...
> **Historical 0.3.4.0-B / V0.2-era implementation brief — 非 V1 Current。** 本文保留当时的实现导航、取证与历史约束；其中指向 R2、旧 Setup / Preset / Bootstrap 的内容不得覆盖 Fish Habit Editor V1 Current。V1 开发先读 [`fish-habit-editor-v1/implementation-brief.md`](fish-habit-editor-v1/implementation-brief.md)。
